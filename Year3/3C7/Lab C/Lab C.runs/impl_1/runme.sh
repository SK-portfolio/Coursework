...
HD_PWD='C:/Users/skomo/Desktop/3C7 Labs/Lab C/Lab C.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sbra_testbench.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sbra_testbench.tcl -notrace
