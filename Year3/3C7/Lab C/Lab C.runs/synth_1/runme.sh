...
HD_PWD='C:/Users/skomo/Desktop/3C7 Labs/Lab C/Lab C.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sbra_testbench.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sbra_testbench.tcl
