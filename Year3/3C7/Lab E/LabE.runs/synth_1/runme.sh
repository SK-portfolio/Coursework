...
HD_PWD='C:/Users/skomo/Desktop/3C7 Labs/Lab E/LabE.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sixbit_ripple_adder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sixbit_ripple_adder.tcl
