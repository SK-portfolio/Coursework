...
HD_PWD='C:/Users/skomo/Desktop/3C7 Labs/Lab E/LabE.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sixbit_ripple_adder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sixbit_ripple_adder.tcl -notrace
